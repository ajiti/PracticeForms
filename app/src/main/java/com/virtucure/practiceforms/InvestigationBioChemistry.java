...
public class InvestigationBioChemistry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppCompatButton  saveBtn = (AppCompatButton) findViewById(R.id.inbsave);
                ...
                try {
                    if (formView != null) {
                        ...
                        if (ch1.isChecked() && ch2.isChecked() && ch3.isChecked() && ch4.isChecked() && ch5.isChecked() && ch6.isChecked() && ch7.isChecked()
                                && ch8.isChecked() && ch9.isChecked() && ch10.isChecked() && ch11.isChecked() && ch12.isChecked() && ch13.isChecked() && ch14.isChecked() && ch15.isChecked()
                                && ch16.isChecked() && ch17.isChecked() && ch18.isChecked() && ch19.isChecked() && ch20.isChecked() && ch21.isChecked() && ch22.isChecked()
                                && ch23.isChecked() && ch24.isChecked() && ch25.isChecked() && ch26.isChecked() && ch27.isChecked() && ch28.isChecked() && ch29.isChecked() && ch30.isChecked()
                                && ch31.isChecked() && ch32.isChecked() && ch33.isChecked() && ch34.isChecked() && ch35.isChecked() && ch36.isChecked() && ch37.isChecked()
                                && ch38.isChecked() && ch39.isChecked() && ch40.isChecked() && ch41.isChecked() && ch42.isChecked() && ch43.isChecked() && ch44.isChecked() && ch45.isChecked()
                                && ch46.isChecked() && ch47.isChecked() && ch48.isChecked() && ch49.isChecked() && ch50.isChecked() && ch51.isChecked() && ch52.isChecked()
                                && ch53.isChecked() && ch54.isChecked() && ch55.isChecked() && ch56.isChecked() && ch57.isChecked() && ch58.isChecked() && ch59.isChecked() && ch60.isChecked()
                                && ch61.isChecked() && ch62.isChecked() && ch63.isChecked() && ch64.isChecked() && ch65.isChecked() && ch66.isChecked() && ch67.isChecked() && ch68.isChecked()) {
